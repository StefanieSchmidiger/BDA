...
#define LedGreen_ClrVal()    LEDpin2_ClrVal() /* put the pin on low level */
#define LedGreen_SetVal()    LEDpin2_SetVal() /* put the pin on high level */
#define LedGreen_SetInput()  LEDpin2_SetInput() /* use the pin as input pin */
#define LedGreen_SetOutput() LEDpin2_SetOutput() /* use the pin as output pin */

#define LedGreen_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */


#define LedGreen_On() LEDpin2_ClrVal()
/*
** ===================================================================
...
#define LedGreen_Off() LEDpin2_SetVal()
/*
** ===================================================================
...
#define LedGreen_Neg() LEDpin2_NegVal()
/*
** ===================================================================
...
#define LedGreen_Get() (!(LEDpin2_GetVal()))
/*
** ===================================================================
