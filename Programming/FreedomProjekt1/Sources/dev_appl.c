...
{    
  ...
  DSM_SetDeviceMode(DSM_MODE_COM3);
}
...
void DA_InitDSM (void)
{
  ...
  DeviceCom->processDataIn = 0x80;		// set default values for sensor
  DeviceCom->processDataOut = 0x80;
...
void DAL_Read_ind (UInteger16T index, UInteger8T subindex, UInteger8T * data)
{
  ...
  UInteger8T response_length;
  switch(index)
  {
  // ToDo: add Index 0,1,4 in DAL_Read_ind as they are mandatory! (see Table B.8)
    ...
    case 0x10:
      ...
      data[5] = 'r';                                                            // VendorName
      data[6] = '-';                                                            // VendorName
      data[7] = 10;                                                             // ASCII line feed
      response_length=8;														// number of elements in array
      break;
    ...
    case 0x11:
      ...
      data[2] = 'x';                                                            // VendorText
      data[3] = 't';                                                            // VendorText
      data[4] = 10 ;                                                            // ASCII line feed
      response_length=5;														// number of elements in array
      break;

    case 0x12:
      data[0] = 'n';                                                            // ProductName
      data[1] = 'a';                                                            // ProductName
      data[2] = 'm';                                                            // ProductName
      data[3] = 'e';                                                            // ProductName
      data[4] = 10 ;                                                            // ASCII line feed                                                                          // ProductName
      response_length=5;														// number of elements in array
      break;
    ...
    case 0x13:
      data[0] = 'i';                                                            // ProductID
      data[1] = 'd';                                                            // ProductID
      data[2] = 10 ;                                                            // ASCII line feed                                                                           // ProductID
      response_length=3;														// number of elements in array
      break;

    case 0x14:
      data[0] = 't';                                                            // ProductText
      data[1] = 'e';                                                            // ProductText
      data[2] = 'x';                                                            // ProductText
      data[3] = 't';                                                            // ProductText
      data[4] = 10 ;                                                            // ASCII line feed                                                                          // ProductText
      response_length=5;														// number of elements in array
      break;

    case 0x15:
      data[0] = 'n';                                                            // ProductNumber
      data[1] = 'u';                                                            // ProductNumber
      data[2] = 'm';                                                            // ProductNumber
      data[3] = 'b';                                                            // ProductNumber
      data[4] = 'e';                                                            // ProductNumber
      data[5] = 'r';                                                            // ProductNumber
      data[6] = '-';                                                            // ProductNumber
      data[7] = 10;                                                             // ASCII line feed                                                                          // SerialNumber
      response_length=8;														// number of elements in array
      break;

    case 0x16:      
      data[0] = 'r';                                                            // HardwareRevision
      data[1] = 'e';                                                            // HardwareRevision
      data[2] = 'v';                                                            // HardwareRevision
      data[3] = '-';                                                            // HardwareRevision
      data[4] = 10 ;                                                            // ASCII line feed                                                                          // HardwareRevision
      response_length=5;														// number of elements in array
      break;
                    ...
                    UInteger8T  dataLength, UInteger8T * data)
{
  ...
  switch(index)
  {
  case 0x00:										// Master command to switch to operating states
	break;

  case 0x01:										// Actual cycle duration used by the Master to address the Device
	DeviceCom->masterCycleTime = *data;				// condition: masterCycleTime is in first element of the array.
	break;

  case 0x02:										// Minimum cycle duration supported by a Device. Is a performance feature of the Device
	DeviceCom->minCycleTime = *data;
	break;

  case 0x03:										// Information about implemented options related to M-sequence and physical configuration
	DeviceCom->msequenceCapability = *data;
	break;

  case 0x04:										// ID of the used protocol version for implementation (shall be set to 0x11
	DeviceCom->revisionID = *data;
	break;

  case 0x05:										// Number and structure of input data (Process Data from Device to Master)
	DeviceCom->processDataIn = *data;
	break;

  case 0x06:										// Number and structure of output data (Process Data from Master to Device)
	DeviceCom->processDataOut = *data;
	break;

  case 0x07:										// Unique vendor identification (assigned by IO-Link community)
	DeviceIdent->vendorID_HI = *data;
	break;

  case 0x08:										// Unique vendor identification (assigned by IO-Link community)
	DeviceIdent->vendorID_LO = *data;
	break;

  case 0x09:										// Unique Device Identification allocated by a vendor
	DeviceIdent->deviceID_HI = *data;
	break;

  case 0x0A:										// Unique Device Identification allocated by a vendor
	DeviceIdent->deviceID_MID = *data;
	break;

  case 0x0B:										// Unique Device Identification allocated by a vendor
	DeviceIdent->deviceID_LO = *data;
	break;

  default:
	return DAL_Write_err(0x80, 0x11);				// no error details
  }
  DAL_Write_rsp();
}
...
{
  // ToDo: what to do when aborted? p.106
}
...
{
  fprintf(stderr, "DAL_Control_ind\tPdOut is ");
  if (controlCode)
...
{
  // ToDo: implement events -> confirmation and requests! Add second function for this
}
